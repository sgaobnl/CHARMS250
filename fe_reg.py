...
class FE_glbl:
    ...
    def fe_glbl_reg(self,sdc=0,slkh=0,s16=0,stb=0,slk=0,sdac=0,sdacsw=0,sdd=0, sgp = 0):
        #-----------global register 1-----------#
        ...
        #LSB------------------------------------------MSB
        temp1 = ((slk & 0x01) << 7) + ((stb & 0x03) << 5) + ((s16 & 0x01) << 4) + ((slkh & 0x01) << 3) + ((sdc & 0x01) << 2)+ ((sdd & 0x01) << 1)+ (sgp & 0x01) 
